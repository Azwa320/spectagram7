        ...
        if (!this.state.fontsLoaded) {
          ...
          return (
            ...
            this.signInWithGoogleAsync()}>
                <TouchableOpocity style={styles.button}>
                  <Image
                    style={styles.googleIcon}
                    source={require('../assets/google_icon.png')}></Image>
                  <Text style={styles.googleIcon}>Sign with google</Text>
                </TouchableOpocity>
              </View>
              <View style={styles.cloudContainer}>
                <Image
                  style={styles.cloudImage}
                  source={require('../assets/cloud.png')}></Image>
              </View>
            </View>
          );
        }
...
const styles = StyleSheet.create({
    ...
    appTitle: { flex: 0.4, justifyContent: 'center', alignItems: 'center' },
    appIcon: { width: RFValue(130), height: RFValue(130), resizeMode: 'contain' },
    appTitleText: {
      color: 'white',
      textAlign: 'center',
      fontSize: RFValue(40),
